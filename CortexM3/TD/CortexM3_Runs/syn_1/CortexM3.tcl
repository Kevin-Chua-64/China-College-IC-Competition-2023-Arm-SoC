...
set rc [catch {
  ...
  export_db {CortexM3_elaborate.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  read_adc ../../CortexM3_IO.adc
  optimize_rtl
  report_area -file CortexM3_rtl.area
  export_db {CortexM3_rtl.db}
} RESULT]
if {$rc} {
  step_error opt_rtl
  return -code error $RESULT
...
set rc [catch {
  read_sdc
  optimize_gate -maparea CortexM3_gate.area
  legalize_phy_inst
  export_db {CortexM3_gate.db}
} RESULT]
if {$rc} {
  step_error opt_gate
  return -code error $RESULT
